...
CREATE TABLE `pre_common_cache` (
  ...
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '过期时间',
...
CREATE TABLE `pre_common_syscache` (
  ...
  `dateline` int(10) unsigned NOT NULL COMMENT '过期时间',
...
INSERT INTO `pre_common_syscache` VALUES ('setting','¬우sr\0java.util.HashMapہV`σ\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\noltimespansr\0java.lang.Long;䑌#݂\0J\0valuexr\0java.lang.Number¬ɂ\0\0xp\0\0\0\0\0\0\0\nx',1491667478);
