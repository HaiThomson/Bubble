 ...
 */
package source.kernel.db.dbutils;
...
public class BasicRowProcessor implements RowProcessor {
     ...
     *
     * @see source.kernel.db.dbutils.RowProcessor#toArray(ResultSet)
     ...
     * @see source.kernel.db.dbutils.RowProcessor#toBean(ResultSet, Class)
     * @see source.kernel.db.dbutils.BeanProcessor#toBean(ResultSet, Class)
     ...
     * @see source.kernel.db.dbutils.RowProcessor#toBeanList(ResultSet, Class)
     * @see source.kernel.db.dbutils.BeanProcessor#toBeanList(ResultSet, Class)
     * @param <T> The type of bean to create
     * @param rs ResultSet that supplies the bean data
     * @param type Class from which to create the bean instance
     * @throws SQLException if a database access error occurs
     ...
     * @throws SQLException if a database access error occurs
     * @see source.kernel.db.dbutils.RowProcessor#toMap(ResultSet)
     */
    @Override
