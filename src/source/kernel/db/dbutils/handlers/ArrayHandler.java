 ...
 */
package source.kernel.db.dbutils.handlers;

import java.sql.ResultSet;
import java.sql.SQLException;

import source.kernel.db.dbutils.BasicRowProcessor;
import source.kernel.db.dbutils.ResultSetHandler;
import source.kernel.db.dbutils.RowProcessor;
 ...
 * thread safe.
 *
 * @see source.kernel.db.dbutils.ResultSetHandler
 */
public class ArrayHandler implements ResultSetHandler<Object[]> {
     ...
     * @see source.kernel.db.dbutils.ResultSetHandler#handle(ResultSet)
     */
    @Override
